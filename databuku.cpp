...
void DataBuku::createBuku(QString judul, QString penerbit, QString author)
{
...
void DataBuku::updateBuku(int row, int col, QString value)
{
    QFile file(filePath);
    QString str = "";
    Buku *temp = head;
...
void DataBuku::deleteBuku(int id) {
